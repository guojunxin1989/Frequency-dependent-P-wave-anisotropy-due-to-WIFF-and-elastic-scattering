...
% hold on;
% semilogx(f,real(tpE(:,5)),'m','linewidth',1.5);
hold on;
...
% hold on;
% semilogx(f,real(tpD(:,5)),'m--','linewidth',1.5);
...
% hold on;
% semilogx(f,imag(tpE(:,5)),'m','linewidth',1.5);
hold on;
...
% hold on;
% semilogx(f,imag(tpD(:,5)),'m--','linewidth',1.5);
